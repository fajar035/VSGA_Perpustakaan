<div id="label-page">
    <h3>Tampil pengembalian</h3>
</div>
<div id="content">

    
        <a target="_blank" href="pages/cetak_transaksi_pengembalian.php"><img src="print.png" height="50px" height="50px"></a>
    ...
    <table id="tabel-tampil">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if ($pencarian != "") {
                $sql = "SELECT tbtransaksi.*, b.status, b.judulbuku, a.nama FROM tbtransaksi 
                        ...
                        WHERE b.status = 0 AND tbtransaksi.status_peminjaman = 0 AND
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $r_tampil_kategori['tglkembali']; ?></td>
                    <td>
                        <div class="tombol-opsi-container"><a href="proses/transaksi-pengembalian-batal-proses.php?id=<?php echo $r_tampil_kategori['id_transaksi']; ?>" onclick="return confirm ('Apakah Anda Yakin?')" class="tombol btn btn-danger">Batal</a></div>
                    </td>
                </tr>
        <?php $nomor++;
            }
